...
Beginning with version 2.3, if the guarantor is an organization, send a Delete Indication value ("") in [_GT1-3 - Guarantor Name_](#gt1-3-guarantor-name-xpn-00407) and put the organization name in [_GT1-21 - Guarantor Organization Name_](#gt1-21-guarantor-organization-name-xon-00425). Either guarantor name or guarantor organization name is required.

module V2AD
  ...
  def extract_16_3_13(section, opts = {})
    ...
    event = V2AD.v2.events['E22'].find { |e| e.section.num == '16.3.12' }
    ...
    resp_struct = process_msg_structure_table(tables.shift, section, :msg_struct_code => 'RSP_E22')
